...
•Dockerização: A presença de um Dockerfile indica que a API pode ser empacotada com todas as suas dependências.
•Kamal: O uso do Kamal mostra que o desenvolvedor está atualizado com as ferramentas modernas de deploy do ecossistema Rails.
